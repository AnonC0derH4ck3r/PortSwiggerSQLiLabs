...
The goal of the lab is to return the `0oLqRX` string. Since, we know that 2nd column is returning a `TEXT` datatype. Hence, I used the following payload to solve the lab. :-
